...
export declare function setPiece(matrix: Matrix, positionedPiece: PositionedPiece): Matrix;
export declare function clearFullLines(matrix: Matrix): [Matrix, number[], number];
